  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="VaibhavSahu" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="VaibhavSahu" />
      ...
      >
        ...
        <div className="flex items-center gap-5">
          <Link href="/">
            <span className="text-lg font-semibold">Vaibhav Sahu</span>
          </Link>
          <div className="flex gap-2"> 
          <a
            href="https://github.com/sahuvaibhav1999"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/vaibhav-sahu-112a8a134"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground transition hover:text-foreground"
